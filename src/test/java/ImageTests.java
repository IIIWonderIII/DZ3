...
public class ImageTests extends BaseTest {
    ...
    @BeforeEach
    void beforeTest() {
        byte[] byteArray = getFileContent("src/test/resources/1.jpg");
    ...
    void uploadFileImageTest() {
        uploadedImageId = given()
                .headers("Authorization", token)
                .multiPart("image", new File("src/test/resources/1.jpg"))
                .expect()
                .statusCode(200)
                .when()
    ...
    void uploadJPEGFormatTest() {
        String encodedFile;
        byte[] byteArray = getFileContent("src/test/resources/2.jpeg");
        encodedFile = Base64.getEncoder().encodeToString(byteArray);
        uploadedImageId = given()
                .headers("Authorization", token)
                .multiPart("image", encodedFile)
    ...
    void uploadGIFFormatTest() {
        String encodedFile;
        byte[] byteArray = getFileContent("src/test/resources/adventure-time-2.gif");
        encodedFile = Base64.getEncoder().encodeToString(byteArray);
        uploadedImageId = given()
                .headers("Authorization", token)
                .multiPart("image", encodedFile)
    ...
    void uploadPNGFormatTest() {
        String encodedFile;
        byte[] byteArray = getFileContent("src/test/resources/2.png");
        encodedFile = Base64.getEncoder().encodeToString(byteArray);
        uploadedImageId = given()
                .headers("Authorization", token)
                .multiPart("image", encodedFile)
    ...
    void uploadFile1x1pixelTest() {
        String encodedFile;
        byte[] byteArray = getFileContent("src/test/resources/3.png");
        encodedFile = Base64.getEncoder().encodeToString(byteArray);
        uploadedImageId = given()
                .headers("Authorization", token)
                .multiPart("image", encodedFile)
    ...
    void uploadBMPFormatTest() {
        String encodedFile;
        byte[] byteArray = getFileContent("src/test/resources/2.bmp");
        encodedFile = Base64.getEncoder().encodeToString(byteArray);
        uploadedImageId = given()
                .headers("Authorization", token)
                .multiPart("image", encodedFile)
